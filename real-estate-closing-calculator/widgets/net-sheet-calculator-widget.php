...
class Net_Sheet_Calculator_Widget extends \Elementor\Widget_Base {
    ...
    public function get_script_depends() {
        return ['recc-utils', 'recc-pdf-generator', 'recc-email-handler', 'recc-message-handler', 'net-sheet-calculator-script'];
    }
    ...
    protected function render() {
        ...
        $calculator_id = 'recc-' . uniqid();?>
        <div class="recc-calculator" id="<?php echo esc_attr($calculator_id); ?>">
            <form class="recc-form">
                <div class="recc-fields-wrap">
                    ...
                    <div class="recc-section">
                        <h5 class="recc-section__title"><?php echo esc_html__('Transaction Summary', 'net-sheet-calculator'); ?></h5>
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-purchase-price">
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-other-credits">
                                <?php echo esc_html($settings['other_credits_label']); ?>
                                <?php if (!empty($settings['other_credits_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['other_credits_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-gross-proceeds">
                                <?php echo esc_html($settings['gross_proceeds_label']); ?> <?php if (!empty($settings['gross_proceeds_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['gross_proceeds_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                    ...
                    <div class="recc-section">
                        <h5 class="recc-section__title"><?php echo esc_html__('Mortgage & Liens', 'net-sheet-calculator'); ?></h5>
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-mortgage-payoff">
                                <?php echo esc_html($settings['mortgage_payoff_label']); ?>
                                <?php if (!empty($settings['mortgage_payoff_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['mortgage_payoff_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-other-mortgage-payoff">
                                <?php echo esc_html($settings['other_mortgage_payoff_label']); ?>
                                <?php if (!empty($settings['other_mortgage_payoff_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['other_mortgage_payoff_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-special-assessment-payoff">
                                <?php echo esc_html($settings['special_assessment_payoff_label']); ?>
                                <?php if (!empty($settings['special_assessment_payoff_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['special_assessment_payoff_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-lien-release-tracking-fee">
                                <?php echo esc_html($settings['lien_release_tracking_fee_label']); ?>
                                <?php if (!empty($settings['lien_release_tracking_fee_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['lien_release_tracking_fee_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                    ...
                    <div class="recc-section">
                        <h5 class="recc-section__title"><?php echo esc_html__('Taxes & Government Fees', 'net-sheet-calculator'); ?></h5>
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-property-taxes-due">
                                <?php echo esc_html($settings['property_taxes_due_label']); ?>
                                <?php if (!empty($settings['property_taxes_due_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['property_taxes_due_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-michigan-transfer-tax">
                                <?php echo esc_html($settings['michigan_transfer_tax_label']); ?>
                                <?php if (!empty($settings['michigan_transfer_tax_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['michigan_transfer_tax_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-revenue-stamps">
                                <?php echo esc_html($settings['revenue_stamps_label']); ?>
                                <?php if (!empty($settings['revenue_stamps_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['revenue_stamps_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                    ...
                    <div class="recc-section">
                        <h5 class="recc-section__title"><?php echo esc_html__('Title & Closing Fees', 'net-sheet-calculator'); ?></h5>
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-settlement-fee">
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-security-fee">
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-title-insurance-policy">
                                <?php echo esc_html($settings['title_insurance_policy_label']); ?>
                                <?php if (!empty($settings['title_insurance_policy_description'])): ?>
                                    <div class="recc-field__description"><?php echo $settings['title_insurance_policy_description']; ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                    ...
                    <div class="recc-section">
                        <h5 class="recc-section__title"><?php echo esc_html__('Agent Commissions', 'net-sheet-calculator'); ?></h5>
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-commission-realtor">
                                <?php echo esc_html($settings['commission_realtor_label']); ?>
                                <?php if (!empty($settings['commission_realtor_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['commission_realtor_description']); ?></div>
                                    <?php endif; ?>
                                </label>
                                <div class="recc-field__input-wrap recc-field__group">
                                    <input type="text"
                                    class="recc-input recc-input--percentage"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-commission-realtor-extra">
                                <?php echo esc_html($settings['commission_realtor_extra_label']); ?>
                                <?php if (!empty($settings['commission_realtor_extra_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['commission_realtor_extra_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                    ...
                    <div class="recc-section">
                        <h5 class="recc-section__title"><?php echo esc_html__('Utilities & HOA', 'net-sheet-calculator'); ?></h5>
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-current-water">
                                <?php echo esc_html($settings['current_water_label']); ?>
                                <?php if (!empty($settings['current_water_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['current_water_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-hoa-assessment">
                                <?php echo esc_html($settings['hoa_assessment_label']); ?>
                                <?php if (!empty($settings['hoa_assessment_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['hoa_assessment_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-water-escrow">
                                <?php echo esc_html($settings['water_escrow_label']); ?>
                                <?php if (!empty($settings['water_escrow_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['water_escrow_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                    ...
                    <div class="recc-section">
                        <h5 class="recc-section__title"><?php echo esc_html__('Miscellaneous Seller Costs', 'net-sheet-calculator'); ?></h5>
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-home-warranty">
                                <?php echo esc_html($settings['home_warranty_label']); ?>
                                <?php if (!empty($settings['home_warranty_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['home_warranty_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-fha">
                                <?php echo esc_html($settings['fha_label']); ?>
                                <?php if (!empty($settings['fha_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['fha_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-misc-cost-seller">
                                <?php echo esc_html($settings['misc_cost_seller_label']); ?>
                                <?php if (!empty($settings['misc_cost_seller_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['misc_cost_seller_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                        ...
                        <div class="recc-field">
                            <label class="recc-field__label" for="<?php echo esc_attr($calculator_id); ?>-seller-attorney-fee">
                                <?php echo esc_html($settings['seller_attorney_fee_label']); ?>
                                <?php if (!empty($settings['seller_attorney_fee_description'])): ?>
                                    <div class="recc-field__description"><?php echo esc_html($settings['seller_attorney_fee_description']); ?></div>
                                <?php endif; ?>
                            </label>
                            <div class="recc-field__input-wrap">
                                <input type="text"
                ...
                <div class="recc-total-wrap">                    
                    ...
                    <div class="recc-section recc-section--totals">
                        <h5 class="recc-section__title"><?php echo esc_html__('Final Totals', 'net-sheet-calculator'); ?></h5>
                        <div class="recc-field">
