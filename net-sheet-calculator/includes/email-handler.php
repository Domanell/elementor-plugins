<?php
/**
 * Email handler for Net Sheet Calculator
 * 
...
class NSC_Email_Handler {
    ...
    public static function init() {
        ...
        add_action('wp_ajax_nsc_send_email', array(__CLASS__, 'handle_email_request'));
        add_action('wp_ajax_nopriv_nsc_send_email', array(__CLASS__, 'handle_email_request'));
    }
    ...
    public static function handle_email_request() {
        ...
        if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'nsc_email_nonce')) {
    ...
    private static function get_email_body($pdf_data) {
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
            <div style="background-color: #f7f7f7; padding: 20px; border-bottom: 3px solid #ddd;">
                <h1 style="color: #333; margin: 0;">Net Sheet Calculator Results</h1>
                <p style="margin: 5px 0 0 0;">From ' . esc_html($site_name) . '</p>
            </div>
            
            <div style="padding: 20px;">
                <p>Thank you for using our Net Sheet Calculator. Please find your results attached as a PDF document.</p>
